...
locals {
  ...
  kubernetes_version = "1.35" #data.azurerm_kubernetes_service_versions.current.versions[length(data.azurerm_kubernetes_service_versions.current.versions) - 1]
  istio_version         = ["asm-1-28"]
